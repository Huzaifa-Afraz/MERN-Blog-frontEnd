...
export default function Card(props) {
  ...
  const [Note, editnote]=useState({id:"",title:"",descreption:""});
...
// console.log(note)
  ...
  <div className="card-body">
    ...
    {localStorage.getItem('token') &&<><i className="fa-regular fa-pen-to-square c-pointer" onClick={()=>handleEdit(note._id,note.title, note.descreption, note.tags)}>e</i>
